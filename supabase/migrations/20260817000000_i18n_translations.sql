-- ריבוי שפות: עמודת תרגומים jsonb לכל טבלת תוכן.
-- העברית נשארת בשדות הבסיס; התרגומים נשמרים לפי קוד שפה, למשל:
--   site_content.translations = {"en": {"texts": {...}, "business": {...}}, "fr": ...}
--   listings.translations     = {"en": {"title": "...", "description": "..."}, ...}
--   site_items.translations   = {"en": {"title": "...", "description": "...", "price_note": "..."}, ...}
-- שדה חסר בתרגום נופל חזרה לעברית בצד הלקוח.
...
-- עדכון הפונקציה הציבורית כך שתחזיר גם את התרגומים (לתוכן ולפריטים)
