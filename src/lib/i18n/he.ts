...
export const he = {
  ...
  properties: {
    ...
    web: {
      title: "נמצא עכשיו בלוחות (סריקה חיה)",
      subtitle:
        "מודעות של משרדי תיווך שנמצאו ברגע זה ביד2, קומו ועוד, ועדיין לא במאגר שלנו. הפנייה נעשית דרך הסוכן שלכם.",
  ...
  misc: {
    noInfo: "אין מידע",
    /* מוצג בלשונית שנפתחת מיד בהקלקה, עד שהליד נשמר והלשונית מנווטת לוואטסאפ */
    openingWhatsApp: "פותחים וואטסאפ…",
  ...
  portal: {
    ...
    aiMarketResultsHint:
      "מודעות של משרדי תיווך אחרים שכבר נמצאות במאגר שלנו (נסרק כל לילה). הפנייה נעשית דרך הסוכן שלכם.",
    aiNoResults: "לא נמצאו נכסים שתואמים לבקשה. נסו לנסח אחרת או הרחיבו את הקריטריונים.",
    /* מודעות מהשוק מוצגות רק כשהן של משרד תיווך — התגית מציגה את זה ללקוח */
    brokerTag: "מתיווך",
    brokerNamed: (name: string) => `מתיווך ${name}`,
  },
  ...
  limits: {
    ...
    aiDaily:
      "הגעתם למכסת החיפושים החכמים היומית. הירשמו לסוכן החכם והוא ימשיך לחפש עבורכם, או פנו אלינו ישירות.",
