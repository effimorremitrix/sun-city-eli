...
export const en: Dict = {
  ...
  auth: {
    ...
    codeSent: "We sent a verification code by SMS to the number you entered.",
    phoneInvalid: "Please enter a valid Israeli mobile number",
  ...
  portal: {
    ...
    matchesTitle: "Properties Matching You",
    noMatches:
      "No properties match your search profile right now — as soon as a matching one is published it will appear here.",
    matchBadge: (n: number) => `${n}% match`,
    viaProfile: (label: string) => `by "${label}"`,
    favoritesTitle: "Saved Properties",
    noFavorites: "You haven't saved any properties yet. Tap ⭐ on a property to keep it here.",
    fbInterested: "I'm interested",
    fbNotRelevant: "Not for me",
    fbCallback: "Have an agent call me",
    fbSave: "Save property",
    fbSaved: "Saved",
    fbCallbackOk: "Got it! The agent will get back to you soon.",
    fbSavedMsg: "The property was saved to your list.",
    fbUpdated: "Your feedback was saved.",
    agentCardTitle: "My Agent",
    agentSiteLink: "Agent's page",
    matchNear: "close",
    matchCriteria: {
      deal: "Deal type",
      city: "City",
