...
export const fr: Dict = {
  ...
  sold: {
    ...
    subtitle: (n: number) =>
      n >= 3
        ? `${n} appartements réels que nous avons déjà vendus — comme nous vendrons le vôtre.`
        : "Des appartements réels que nous avons déjà vendus — comme nous vendrons le vôtre.",
    stamp: "VENDU",
