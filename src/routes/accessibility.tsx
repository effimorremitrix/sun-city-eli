  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-14">
      ...
      <div className="mt-6 space-y-4 leading-relaxed text-foreground">
        <p>
          אנו ב{business.name} רואים חשיבות רבה במתן שירות שוויוני לכלל הגולשים, ופועלים
          להנגשת האתר בהתאם לתקן הישראלי 5568 ולתקנות שוויון זכויות לאנשים עם מוגבלות
          (התאמות נגישות לשירות), תשע"ג-2013, ברמת AA.
        </p>
        ...
        <p>
          ייתכנו רכיבים או תכנים של צד שלישי (כגון מפות Google) שאינם בשליטתנו המלאה. אנו
          ממשיכים לשפר את הנגישות באופן שוטף.
        </p>
